...
#define LOCALGIT "/home/oleg/Downloads"
#define ORIGINURL "https://github.com/OTube/test.git"
                    ...
                    void *payload)
{
    ...
    sprintf(username, "%s", "OTube");
    sprintf(password, "%s", "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");
